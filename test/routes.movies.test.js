...
describe('routes : movies', () => {
  ...
  describe('PUT /v1/api/movies', () => {
    ...
    it('should throw an error when movie does not exist', (done) => {
      chai.request(server)
  ...
  describe('DELETE /api/v1/movies/:id', () => {
    ...
    it('should throw an error when movie does not exist', (done) => {
      ...
      .select('*')
      .then((moviesBefore) => {
        const lengthBeforeDelete = moviesBefore.length;
        chai.request(server)
        ...
        .end((err, res) => {
          ...
          .select('*')
          .then((moviesAfter) => {
            moviesAfter.length.should.eql(lengthBeforeDelete);
            done();
          });
        });
      });
